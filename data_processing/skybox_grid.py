...
basename = "assets/rooms/room_2"
skybox_image = "assets/rooms_processed/converted_room2.png"
pano_image = "assets/rooms_processed/pano_room2.png"


indices = []
suffixes = list(os.listdir(basename))
