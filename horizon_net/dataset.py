...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="Pick a data id to visualize." "-1 for visualize all data",
    )
    parser.add_argument("--flip", action="store_true", help="whether to random flip")
    parser.add_argument(
        "--rotate", action="store_true", help="whether to random horizon rotation"
    )
    parser.add_argument(
        "--gamma", action="store_true", help="whether to random luminance change"
    )
    parser.add_argument(
        "--stretch", action="store_true", help="whether to random pano stretch"
    )
